...
# Key the compinit file on zsh version - compinit rebuilds any dump generated by a different version.
ZSH_COMPINIT_DUMP_FILE="$HOME/.cache/zsh/zcompdump-$ZSH_VERSION"
mkdir -p ${ZSH_COMPINIT_DUMP_FILE:h}
autoload -U compinit && compinit -d "$ZSH_COMPINIT_DUMP_FILE"
