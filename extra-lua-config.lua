...
vim.keymap.set('n', '<leader>tf', ':TSTextobjectSelect @function.outer<CR>', 
  { desc = 'Select outer function', silent = true })
vim.keymap.set('n', '<leader>ti', ':TSTextobjectSelect @function.inner<CR>', 
  { desc = 'Select inner function', silent = true })

-- Function navigation
vim.keymap.set('n', ']f', ':TSTextobjectGotoNextStart @function<CR>', 
  { desc = 'Go to next function start', silent = true })
vim.keymap.set('n', '[f', ':TSTextobjectGotoPreviousStart @function<CR>', 
  { desc = 'Go to previous function start', silent = true })
vim.keymap.set('n', ']F', ':TSTextobjectGotoNextEnd @function<CR>', 
  { desc = 'Go to next function end', silent = true })
vim.keymap.set('n', '[F', ':TSTextobjectGotoPreviousEnd @function<CR>', 
  { desc = 'Go to previous function end', silent = true })

-- Function text objects
vim.keymap.set('o', 'af', '<cmd>TSTextobjectSelect @function.outer<CR>', 
  { desc = 'Select outer function', silent = true })
vim.keymap.set('o', 'if', '<cmd>TSTextobjectSelect @function.inner<CR>', 
  { desc = 'Select inner function', silent = true })

-- Class text objects
vim.keymap.set('o', 'ac', '<cmd>TSTextobjectSelect @class.outer<CR>', 
  { desc = 'Select outer class', silent = true })
vim.keymap.set('o', 'ic', '<cmd>TSTextobjectSelect @class.inner<CR>', 
  { desc = 'Select inner class', silent = true })

-- Class navigation (similar to function navigation)
vim.keymap.set('n', ']c', ':TSTextobjectGotoNextStart @class<CR>', 
  { desc = 'Go to next class start', silent = true })
vim.keymap.set('n', '[c', ':TSTextobjectGotoPreviousStart @class<CR>', 
  { desc = 'Go to previous class start', silent = true })
vim.keymap.set('n', ']C', ':TSTextobjectGotoNextEnd @class<CR>', 
  { desc = 'Go to next class end', silent = true })
vim.keymap.set('n', '[C', ':TSTextobjectGotoPreviousEnd @class<CR>', 
  { desc = 'Go to previous class end', silent = true })

-- Lua-based node inspection
vim.keymap.set('n', '<leader>tt', function()
    print(vim.treesitter.get_node():type())
end, { desc = 'Print node type under cursor' })
